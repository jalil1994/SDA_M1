...
public class Main_TBDynamiqueDESC {
	public static void main(String[] args) throws DisplayException {
        ...
        time_analysis.save_values("Tas_Binaire_Dynamique_time_java_Decroissant.plot");
        copy_analysis.save_values("Tas_Binaire_Dynamique_copy_java_Decroissant.plot");
        memory_analysis.save_values("Tas_Binaire_Dynamique_memory_java_Decroissant.plot");
