...
public class Main_TBStatiqueDESC {
	public static void main(String[] args) throws DisplayException {
       ...
       time_analysis.save_values("Tas_Binaire_statique_time_java_Decroissant.plot");
       copy_analysis.save_values("Tas_Binaire_statique_copy_java_Decroissant.plot");
       memory_analysis.save_values("Tas_Binaire_statique_memory_java_Decroissant.plot");
