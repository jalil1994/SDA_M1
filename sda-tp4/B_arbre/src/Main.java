...
/* 	This is the main Class for B-Tree implementation in Java.
 *	It creates a B-Tree Tree with order user value N.
 *	Then Lets the user do the following operations on the BTree Tree
 *		1.Add more Keys to the Tree.
 *		2.Print the entire Tree in preorder.
 *		3.Delete a key from the leaf
 *		4.Search for a Key and print the Node it belongs to
 *	The above menu is put in a while loop so that the User has a easy interface to Test or familiarize with the B-Tree.
 *
...
public class Main 
{
	...
	public static void main(String[] args)
	{
		...
		int n,n2,temp;
		System.out.print("entrer le degre t de l'abre  ");
		n=input.nextInt();
		...
		ArbreB tree = new ArbreB(n);//  B-Tree Tree with order  N is created.

        // Initial Values are added to the Tree.. The user and Input any number of Values.
		System.out.print("\n combien de valeur vous voulez entrer?:  ");	
        n2 = input.nextInt();
		...
		flag=true;
			...
			System.out.println("1. Entrer plus de valeurs dans l'arbre");
			System.out.println("2. afficher l'arbre");
			System.out.println("3. chercher une clef");
			System.out.println("4. supprimer une clef");
            ...
            else
			{
			 	switch(choice)
			 	{
					...
					case 3: //If the User Enters 3 this case is executed and 
                        ...
                        System.out.println("quelle est la clef que vous cherchez:");
